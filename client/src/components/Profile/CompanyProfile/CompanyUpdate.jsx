...
const CompanyUpdate = (props) => {
  ...
  const CompanyUpdateInfo = () => {
    ...
    const data ={
      hc_company_englishName:state.formData.hc_company_englishName,
      hc_company_email:state.formData.hc_company_email,
      _id:state.formData._id
    }

    Axios.post(`/api/company/companyupdateinfo`, data, {
      headers: {
  ...
  return (
    <div>
      {state.isLoading ? (
        ...
        <form onSubmit={CompanyUpdateInfo}>
            ...
            <div className="form-row">
              <div className="col-md-12 mb-3">
                ...
                <input
                  ...
                  id="englishName"
                  value={state.formData.hc_company_englishName}
                  onChange={onEdit}
                  required
                />
              </div>
            ...
            <div className="form-row">
              <div className="col-md-12 mb-3">
                ...
                <input
                  ...
                  id="phonenumber"
                  disabled
                  value={state.formData.hc_company_phoneno}
                />
              </div>
            </div>
            <div className="form-row">
              <div className="col-md-12 mb-3">
                ...
                <input
                  ...
                  className="form-control"
                  id="email"
                  value={state.formData.hc_company_email}
                  onChange={onEdit}
                />
              </div>
            </div>
            ...
            <div className="form-row">
              <div className="col-12 mb-3">
                ...
                <input
                  ...
                  className="form-control"
                  id="bmdcRegNo"
                  value={state.formData.hc_company_reg_no}
                  disabled
                  // onChange={onEdit}
                />
              </div>
