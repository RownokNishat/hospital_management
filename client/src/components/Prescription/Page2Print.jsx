...
import { prescriptionData_peek_dequeue } from "../../redux/reducers/Prescription/prescriptionAction";
...
const ComponentToPrint = forwardRef((props, ref) => {
  ...
  useEffect(() => {
    if (prescriptionData?.length > 0 && navigator.onLine) {
      const headers = {
        "Content-Type": "application/json",
        authorization: `Bearer ${auth.token}`,
        patientId: prescriptionData[0]?.prescriptionHeader?.patientDetail._id,
      };
      prescriptionData.map((i) => {
  ...
  const prescriptionTreatmentData =
    prescriptionData[prescriptionData.length - 1]?.prescriptionData;

  const pdfExportComponent = React.useRef(null);

  const chamber =
    prescriptionData[prescriptionData.length - 1]?.prescriptionHeader.chamber;
  const doctorInfo =
    prescriptionData[prescriptionData.length - 1]?.prescriptionHeader
      .doctorDetail;
  const patientInfo =
    prescriptionData[prescriptionData.length - 1]?.prescriptionHeader
      .patientDetail;
  const today =
    prescriptionData[prescriptionData.length - 1]?.prescriptionHeader.today;
  const degreeData1 =
    prescriptionData[prescriptionData.length - 1]?.prescriptionHeader
      .degreeData1;
  const degreeData2 =
  ...
  const degreeData3 =
    prescriptionData[prescriptionData.length - 1]?.prescriptionHeader
      .degreeData3;
  const allAdvice =
    prescriptionData[prescriptionData.length - 1]?.prescriptionData.advice;
  ...
  return (
    <>
      <div>
        {/* <Pdf targetRef={ref} options={options} x={0.2} y={0.4} filename="code-example.pdf" scale={0.58}>
        ...
        <Print printOnly name="foo"> */}
          ...
          <div className="row">
            <div className="col-lg-3 col-md-4 col-12 justify-content-center flex-column relative-top">
              ...
              !prescriptionTreatmentData?.hc_p_gex_female.Para ? null : (
                <div>
                  ...
                  {prescriptionTreatmentData.hc_p_gex_female.Breast ? (
                    <p className="ms-5  mt-1 mb-0">
                      Breast: {prescriptionTreatmentData.hc_p_gex_female.Breast}
                    </p>
                  ) : (
                    <></>
                  )}
              ...
              !prescriptionTreatmentData?.hc_p_ex_baby.Breathing ? null : (
                <div>
                  <p className={Styles.pdf_leftSideHeader}>In case of Baby</p>
                  {prescriptionTreatmentData?.hc_p_ex_baby
                    .Mothers_disease_during_pregnancy ? (
                    <p className="ms-5  mt-1 mb-0">
                ...
                <div>
                  ...
                  {prescriptionTreatmentData?.hc_p_ex_post_operative_patient
                    ...
                    <p className="ms-5  mt-1 mb-0">
                      ...
                      {
                        prescriptionTreatmentData
                          ?.hc_p_ex_post_operative_patient.OT_procedure
                      }
                    </p>
                  ) : (
                    <></>
                  ...
                  {prescriptionTreatmentData?.hc_p_ex_post_operative_patient
                    ...
                    <p className="ms-5  mt-1 mb-0">
                      ...
                      {
                        prescriptionTreatmentData
                          ?.hc_p_ex_post_operative_patient?.Infection
                      }
                    </p>
                  ) : (
                    <></>
            ...
            <div id="nonFooter" className="col-lg-9 col-md-8 col-12">
...
export default function Page2Print() {
  const ref = useRef();
